...
//!
//! Aggregates JBP (NC, C3, C8, CD) and TIFF (None, LZW, JPEG, Deflate, PackBits)
//! benchmarks into one Criterion executable. Feature-gated benchmarks are compiled
//! only when their respective features are enabled.
