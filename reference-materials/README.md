...
Download the relevant PDFs and place them in this directory for reference during development.

## Usage

Reference these specifications when implementing or validating format support. The directory structure is flexible - organize files as needed for your workflow.
