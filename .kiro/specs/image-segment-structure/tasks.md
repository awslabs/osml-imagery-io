...
- [ ] 1. Create core image types and enums
  - [ ] 1.1 Create `src/jbp/image/mod.rs` with module structure
  ...
  - [ ] 1.2 Implement `PixelValueType` enum in `src/jbp/image/types.rs`
  ...
  - [ ] 1.3 Implement `ImageRepresentation` enum
  ...
  - [ ] 1.4 Implement `InterleaveMode` enum
    - Implement variants: B, P, R, S
    - Implement `from_char()` and `to_char()`
    - _Requirements: 2.5, 5.3-5.6_
  
  - [ ] 1.5 Implement `PixelJustification` enum
    - Implement variants: Right, Left
    - Implement `from_char()` and `to_char()`
    - _Requirements: 1.10_
  
  - [ ] 1.6 Write unit tests for type conversions
    - Test all enum parsing and serialization
    - Test edge cases and invalid inputs
    - _Requirements: 1.6, 1.7, 1.10, 2.5_

- [ ] 2. Implement ImageSubheaderFacade
  - [ ] 2.1 Create `ImageSubheaderFacade` struct in `src/jbp/image/facade.rs`
...
- [ ] 3. Implement BandInfoFacade and LUT support
  ...
  - [ ] 3.5 Write property test for LUT round-trip
...
- [ ] 4. Checkpoint - Verify facade implementation
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement pixel module for uncompressed I/O
  - [ ] 5.1 Create `src/jbp/image/pixel.rs` module
    - Define module structure with encode/decode functions
    - _Requirements: 5.7-5.12, 11.1-11.10_
  
  - [ ] 5.2 Implement `bytes_per_pixel()` function
    - Calculate bytes from PVTYPE and NBPP
    - Handle all PVTYPE/NBPP combinations
    - _Requirements: 11.1-11.10_
  
  - [ ] 5.3 Implement `decode_pixel()` for integer types
...
- [ ] 7. Checkpoint - Verify pixel and interleave modules
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Implement BlockDecoder trait and UncompressedBlockDecoder
  - [ ] 8.1 Create `src/jbp/image/decoder.rs` module
  ...
  - [ ] 8.5 Implement `has_block()` for UncompressedBlockDecoder
    - Validate block coordinates against NBPR, NBPC
    - _Requirements: 6.3_
  
  - [ ] 8.6 Implement `create_block_decoder()` factory
  ...
  - [ ] 8.7 Write property test for block access correctness
  ...
  - [ ] 8.8 Write property test for invalid block coordinates
  ...
  - [ ] 8.9 Write property test for pixel data round-trip
...
- [ ] 9. Extend JBPImageAssetProvider with ImageAssetProvider trait
  ...
  - [ ] 9.6 Write property test for trait compliance
...
- [ ] 12. Implement ImageSubheaderBuilder for writing
  - [ ] 12.1 Create `ImageSubheaderBuilder` struct
    - Store fields as HashMap<String, Value>
    - Store bands as Vec<BandInfoBuilder>
    - _Requirements: 7.1-7.8_
  
  - [ ] 12.2 Implement fluent setter methods
  ...
  - [ ] 12.3 Implement blocking parameter calculation
  ...
  - [ ] 12.5 Implement `BandInfoBuilder` struct
    - Store band fields
    - Implement fluent setters
    - Implement write to StructureWriter
    - _Requirements: 9.1-9.9_
  
  - [ ] 12.6 Write property test for blocking calculation
...
- [ ] 13. Implement Python bindings for ImageAssetProvider
  - [ ] 13.1 Update `src/bindings/image.rs` with ImageAssetProvider methods
    - Expose `has_block()`, `get_block()` methods
    - Expose dimension and pixel type methods
    - _Requirements: 19.1_
  
  - [ ] 13.2 Implement NumPy array return for `get_block()`
    - Convert raw bytes to NumPy array with correct dtype
    - Return array with shape (rows, cols, bands)
    - _Requirements: 19.2, 19.3_
  
  - [ ] 13.3 Implement band selection parameter
    - Accept optional list of band indices
    - Pass to underlying get_block() call
    - _Requirements: 19.4_
  
  - [ ] 13.4 Expose metadata through Python bindings
    - Ensure metadata() method returns image subheader fields
    - _Requirements: 19.5_
  
  - [ ] 13.5 Write Python integration tests
    - Test get_block() returns correct NumPy array
    - Test band selection
    - Test metadata access
    - _Requirements: 19.1-19.5_

- [ ] 14. Integration testing with JITC test files
  - [ ] 14.1 Create integration test for image segment parsing
