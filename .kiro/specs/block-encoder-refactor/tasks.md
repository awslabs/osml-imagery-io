...
- [ ] 1. Create BlockEncoder trait and module structure
  - [ ] 1.1 Create `src/jbp/image/encoder.rs` module
...
- [ ] 2. Implement UncompressedBlockEncoder
  - [ ] 2.1 Create `UncompressedBlockEncoder` struct
    - Store image dimensions, bands, bit depth, IMODE, block dimensions
    - Pre-allocate output buffer
    - Track which blocks have been encoded
    - _Requirements: 2.1, 2.3_
  
  - [ ] 2.2 Implement encode_block() method
  ...
  - [ ] 2.3 Implement IMODE conversion functions
...
- [ ] 3. Checkpoint - Verify UncompressedBlockEncoder
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Implement create_block_encoder factory
  - [ ] 4.1 Create factory function in encoder.rs
...
- [ ] 5. Implement TileAssembler
  - [ ] 5.1 Create `TileAssembler` struct
  ...
  - [ ] 5.2 Implement output_grid_size() method
    - Calculate grid based on image dimensions and output tile size
    - _Requirements: 5.1_
  
  - [ ] 5.3 Implement get_output_tile() method
...
- [ ] 6. Checkpoint - Verify TileAssembler
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Refactor JBPDatasetWriter to use BlockEncoder
  - [ ] 7.1 Add BlockEncoder integration to writer
...
- [ ] 9. Implement round-trip tests
  ...
  - [ ] 9.2 Write property test for tile size round-trip
  ...
  - [ ] 9.3 Write property test for edge blocks
  ...
  - [ ] 9.4 Write property test for block grid calculation
