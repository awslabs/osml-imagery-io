...
- [ ] 1. Set up JPEG module structure and FFI bindings
  - [ ] 1.1 Create `src/jbp/jpeg/mod.rs` with module exports
  ...
  - [ ] 1.2 Create `src/jbp/jpeg/sys.rs` with raw FFI declarations for libjpeg-turbo
  ...
  - [ ] 1.3 Create `src/jbp/jpeg/ffi.rs` with safe Rust wrappers
...
- [ ] 2. Implement JPEG codec core
  ...
  - [ ] 2.3 Write unit tests for COMRAT parsing
    - Test valid COMRAT values ("00.0" to "99.9")
    - Test default quality mapping
    - Test edge cases and invalid inputs
    - _Requirements: 5.1, 5.2, 5.3_

- [ ] 3. Implement JPEG block decoder
  - [ ] 3.1 Create `src/jbp/jpeg/decoder.rs` with JpegBlockDecoder
  ...
  - [ ] 3.2 Add 12-bit decoding support to JpegBlockDecoder
    - Implement 12-bit grayscale decoding using libjpeg API
    - Handle UInt16 output with values in 0-4095 range
    - _Requirements: 1.3_
  
  - [ ] 3.3 Add multiband decoding support
    - Implement IMODE=B (block interleaved) decoding
    - Implement IMODE=S (sequential) decoding
    - Parse band-prefixed JPEG streams
    - _Requirements: 1.6_
  
  - [ ] 3.4 Write unit tests for JPEG decoding
...
- [ ] 4. Implement JPEG block encoder
  - [ ] 4.1 Create `src/jbp/jpeg/encoder.rs` with JpegBlockEncoder
  ...
  - [ ] 4.5 Write unit tests for JPEG encoding
...
- [ ] 5. Checkpoint - Verify codec functionality
  - Ensure all codec unit tests pass
  - Verify FFI bindings work correctly
  - Ask the user if questions arise

- [ ] 6. Integrate JPEG codec with JBP reader
  - [ ] 6.1 Update `src/jbp/image/decoder.rs` to dispatch to JPEG decoder
...
- [ ] 9. Add property-based tests
  - [ ] 9.1 Update `tests/property/strategies.py` with JPEG strategies
  ...
  - [ ] 9.2 Create `tests/property/test_jpeg_roundtrip.py` with Property 1
  ...
  - [ ] 9.3 Add Property 2 test for masked JPEG roundtrip
  ...
  - [ ] 9.4 Add Property 3 test for downsampled JPEG (I1)
...
- [ ] 10. Checkpoint - Verify property tests
...
- [ ] 11. Update documentation
  ...
  - [ ] 11.3 Update `docs/JBP_ROADMAP.md`
