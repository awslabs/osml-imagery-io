...
- [x] 1. Create text subheader structure definition
  - [x] 1.1 Create text subheader definition in `src/jbp/text/mod.rs`
...
- [x] 2. Implement TextSubheaderFacade
  - [x] 2.1 Create `TextSubheaderFacade` struct in `src/jbp/text/facade.rs`
  ...
  - [x] 2.3 Add validation in facade for required field values
    - Validate TE == "TE"
    - Validate ENCRYP == "0"
...
- [x] 3. Checkpoint - Ensure subheader parsing tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement text encoding/decoding functions
  - [x] 4.1 Create text encoding module in `src/jbp/text/encoding.rs`
  ...
  - [x] 4.3 Implement error handling for invalid encoding sequences
...
- [x] 5. Update JBPTextAssetProvider
  - [x] 5.1 Extend `JBPTextAssetProvider` struct in `src/jbp/asset.rs`
    - Add `txtfmt` field to store the text format code
    - Update constructor to accept txtfmt parameter
    - _Requirements: 2.1, 2.2, 2.3, 2.4_

  - [x] 5.2 Implement `TextAssetProvider` trait for `JBPTextAssetProvider`
  ...
  - [x] 5.3 Update `media_type()` to return encoding-aware MIME type
...
- [x] 6. Checkpoint - Ensure asset provider tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Update JBPDatasetReader for text segments
  - [x] 7.1 Update `create_text_subheader_definition()` to use full definition
    - Replace minimal definition with complete JBP Table 5.17-1 definition
    - Register definition in StructureRegistry
    - _Requirements: 1.1_

  - [x] 7.2 Update `parse_segment()` for text segments
  ...
  - [x] 7.3 Implement `extract_text_tres()` method
...
- [x] 8. Checkpoint - Ensure reader tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. Implement BufferedTextAssetProvider
  - [x] 9.1 Create `BufferedTextAssetProvider` struct in `src/buffered/text.rs`
  ...
  - [x] 9.2 Implement `TextAssetProvider` trait for `BufferedTextAssetProvider`
  ...
  - [x] 9.3 Implement `AssetProvider` trait for `BufferedTextAssetProvider`
...
- [x] 10. Checkpoint - Ensure Rust tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Update Python bindings
  - [x] 11.1 Update PyTextAssetProvider to use TextAssetProvider trait
  ...
  - [x] 11.2 Update JBPDatasetReader Python binding
    - Ensure get_asset() returns PyTextAssetProvider for text segments
    - _Requirements: 8.7_

  - [x] 11.3 Add PyBufferedTextAssetProvider binding
    - Expose constructor and builder methods
    - _Requirements: 7.1, 7.2, 7.3_

  - [x] 11.4 Write Python property test for API completeness
    - **Property 14: Python API Completeness**
    - **Validates: Requirements 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7**

- [x] 12. Checkpoint - Ensure Python tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 13. Additional property tests
  - [x] 13.1 Write property test for text segment roundtrip (write and read via NITF)
    - **Property 6: Text Segment Round-Trip**
    - **Validates: Requirements 4.1, 4.2, 4.3, 4.4, 7.1, 7.4, 7.5, 7.6**
    - Test file: `tests/property/test_text_roundtrip.py` (renamed from `test_text_api.py` for consistency)

  - [x] 13.2 Write property test for unknown format code handling
    - **Property 3: Unknown Format Code Handling**
    - **Validates: Requirements 1.4**

  - [x] 13.3 Write property test for invalid TXTALVL reference parsing
    - **Property 5: Invalid TXTALVL Reference Parsing**
    - **Validates: Requirements 3.4**

- [x] 14. Update documentation
  - [x] 14.1 Update `docs/API_DESIGN.md`
  ...
  - [x] 14.2 Update `docs/JBP_ROADMAP.md`
    - Mark Phase 2 (Text Segments) as complete
    - _Requirements: 9.2_

  - [x] 14.3 Update `docs/JBP_CLEVEL_ASSESSMENT.md`
